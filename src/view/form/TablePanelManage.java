...
public class TablePanelManage {
	private static Integer sportsmansCount;
	...
	public static void countProcessed() {
		setSportsmansCount();
		if (sportsmansCount % pageSize == 0)
			countPage = sportsmansCount / pageSize;
		else
			countPage = (sportsmansCount / pageSize) + 1;
	}
	...
	public static void setSportsmansCount() {
		TablePanelManage.sportsmansCount = DataHandler.getSportsmansCount();
	}
