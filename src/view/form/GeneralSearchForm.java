...
public class GeneralSearchForm {
	...
	public void generalSearchForm(boolean startMod) {
		...
		this.buttons.get(0).setText("по фио или виду спорта");
		this.buttons.get(1).setText("по количеству завоеваний титула (макс и мин)");
		this.buttons.get(2).setText("по фио или разряду");
